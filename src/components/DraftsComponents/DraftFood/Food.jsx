...
const Food = () => {
  ...
  const excessConsumptionProtein = calcSurplus(proteinGoal, consumedProtein);
  ...
  const excessConsumptionFat = calcSurplus(fatGoal, consumedFat);
          ...
          <Card>
            ...
            <CardText>
              ...
              <CounterList>
                ...
                <Counter>
                  Goal: <span>{carbohydrateGoal}</span>
                </Counter>
                {/* лічильник залишилось для вуглеводів */}
                <Counter>
                  {warningCarbonohidrates ? 'excess:' : 'left:'}{' '}
                  <span
                    style={{ color: `${warningCarbonohidrates && '#E74A3B'}` }}
                  >
                    {warningCarbonohidrates
                      ? excessConsumptionCarbonohidrates
                      : leftConsumedCarbonohidrates}
                  </span>
                </Counter>
              </CounterList>
            </CardText>
          ...
          <Card>
            ...
            <CardText>
              ...
              <CounterList>
                ...
                <Counter>
                  Goal: <span>{proteinGoal}</span>
                </Counter>
                {/* лічильник залишилось для протеїнів */}
                <Counter>
                  {warningProtein ? 'excess:' : 'left:'}{' '}
                  <span style={{ color: `${warningProtein && '#E74A3B'}` }}>
                    {warningProtein
                      ? excessConsumptionProtein
                      : leftConsumedProtein}
                  </span>
                </Counter>
              </CounterList>
          ...
          <Card>
            ...
            <CardText>
              ...
              <CounterList>
                ...
                <Counter>
                  Goal: <span>{fatGoal}</span>
                </Counter>
                {/* лічильник залишилось для жирів */}
                <Counter>
                  {warningFat ? 'excess:' : 'left:'}{' '}
                  <span style={{ color: `${warningFat && '#E74A3B'}` }}>
                    {warningFat ? excessConsumptionFat : leftConsumedFat}
                  </span>
                </Counter>
              </CounterList>
            </CardText>
